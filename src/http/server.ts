...
async function route(request: IncomingMessage, response: ServerResponse, services: ObservatoryHttpServices): Promise<void> {
  ...
  if (method === "GET" && browserSegments[0] === "projects" && browserSegments[1]) {
